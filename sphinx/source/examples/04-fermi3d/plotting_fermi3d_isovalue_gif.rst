...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_examples_04-fermi3d_plotting_fermi3d_isovalue_gif.py>`
...
.. image-sg:: /examples/04-fermi3d/images/sphx_glr_plotting_fermi3d_isovalue_gif_001.gif
   :alt: plotting fermi3d isovalue gif
   :srcset: /examples/04-fermi3d/images/sphx_glr_plotting_fermi3d_isovalue_gif_001.gif
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  35.516 seconds)
