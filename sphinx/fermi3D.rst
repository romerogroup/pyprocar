...
This work would not have been possible without the amazing packages, `pyvista
<https://docs.pyvista.org/>`_ and `trimesh
...
`trimesh <https://github.com/mikedh/trimesh#how-can-i-cite-this-library>`_::
