...
class QuiverPlot(BasePlotter):
    ...
    # Resolve colormap
    def _plot(
        self, kpath: KPath, bands: np.ndarray, vectors: np.ndarray | Property = None, **kwargs
    ):
        # Validate data
        ...
        self.quiver_kwargs["clim"] = (
            self.clim if "clim" not in self.quiver_kwargs else self.quiver_kwargs["clim"]
        )
