...
class Surface:
    """
        ...
        faces : list of integers (nfaces,3)
            The default is None. The list of connectivity between verts that create the 
            surface.
    ...
    def centers(self):
        ...
        Returns
        -------
        centers : TYPE list of floats (n,3)
            DESCRIPTION. returns a list of centers of faces
    ...
    def set_scalars(self,
        ...
        """
        Sets/Updates the scalars of the surface. Scalars represent a color using
        a color map

        Parameters
        ----------
        scalars : list
            DESCRIPTION. scalars should be the same size as the number of faces
