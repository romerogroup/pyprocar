...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-n",
        type=int,
        help="size in nearest neighbors of the cluster to build",
        default=0,
    )
    ...
    cluster = pp.clusters.Clusters(
        p, verbose=args.verbose, neighbors=Defects.neighbors, marked=Defects.all_defects
    )
