...
"""
    ...
    existing_comment, _ = find_existing_summary_comment(repo_name, pr_number, github_token)
...
def main():
    ...
    _, previous_summary = find_existing_summary_comment(REPO_NAME, PR_NUMBER, GITHUB_TOKEN)
